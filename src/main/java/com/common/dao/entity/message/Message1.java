...
@Entity
@Table(name = "Message")
public class Message1 implements Serializable,Comparable<Message1>{
    ...
    public Message1(int priority, Date frequence, Date departureTime, Date relevantTime, Date delay, String[] duct, String message, String address) {
    ...
    public Message1(Date frequence, Date departureTime, Date relevantTime, Date delay, String[] duct, String message, String address) {
        this.frequence = frequence;
        this.departureTime = departureTime;
        this.relevantTime = relevantTime;
        this.delay = delay;
    ...
    @Override
    public int compareTo(Message1 o) {
