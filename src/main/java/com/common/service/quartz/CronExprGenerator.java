 ...
 */
public class CronExprGenerator implements Serializable {

    public CronExprGenerator(){}
    public CronExprGenerator(Date date){
        CronExprGenerator pCron = new CronExprGenerator();
        pCron.setTime("2:14 A");
        pCron.setMON(true);
        pCron.setStartDate("24-10-2016");
